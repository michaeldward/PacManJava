...
public class PacMan extends JLabel{
    ...
    String UpOpen = "PacManUpOpen.png";
    String LeftOpen = "PacManLeftOpen.png";
    String RightOpen = "PacManRightOpen.png";
    String DownOpen = "PacManDownOpen.png";
    String UpClosed = "PacManUpClosed.png";
    String LeftClosed = "PacManLeftClosed.png";
    String RightClosed = "PacManRightClosed.png";
    String DownClosed = "PacManDownClosed.png";
    Boolean open = false;


    public PacMan(int newXPos, int newYPos, String filename) {
        // this.setText("PacMan");
